...
#include "amd/include/AMDGPUToLLVM/Passes.h"
#include "amd/include/Dialect/AMDGPU/IR/Dialect.h"
...
inline void registerTritonDialects(mlir::DialectRegistry &registry) {
  ...
  mlir::triton::registerConvertAMDGPUToLLVMPass();
  ...
  registry.insert<mlir::triton::TritonDialect, mlir::cf::ControlFlowDialect,
              ...
              mlir::triton::amdgpu::AMDGPUDialect, mlir::ROCDL::ROCDLDialect>();
}
