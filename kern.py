...
reordered = """#blocked = #triton_gpu.blocked<{sizePerThread = [1, 8], threadsPerWarp = [16, 4], warpsPerCTA = [8, 1], order = [0, 1]}>
...
#shared3 = #triton_gpu.shared<{vec = 4, perPhase = 2, maxPhase = 8, order = [1, 0], CTAsPerCGA = [1, 1], CTASplitNum = [1, 1], CTAOrder = [0, 1], hasLeadingOffset = false}>
#shared4 = #triton_gpu.shared<{vec = 4, perPhase = 2, maxPhase = 8, order = [0, 1], CTAsPerCGA = [1, 1], CTASplitNum = [1, 1], CTAOrder = [0, 1], hasLeadingOffset = false}>
module attributes {"triton_gpu.num-ctas" = 1 : i32, "triton_gpu.num-warps" = 8 : i32, triton_gpu.target = "hip:gfx942", "triton_gpu.threads-per-warp" = 64 : i32} {
  tt.func public @_attn_fwd_sliced(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg1: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg2: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg3: f32 , %arg4: !tt.ptr<f32> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg5: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg6: i32 {tt.divisibility = 16 : i32} , %arg7: i32 {tt.divisibility = 16 : i32} , %arg8: i32 {tt.divisibility = 16 : i32} , %arg9: i32 {tt.divisibility = 16 : i32} , %arg10: i32 {tt.divisibility = 16 : i32} , %arg11: i32 {tt.divisibility = 16 : i32} , %arg12: i32 {tt.divisibility = 16 : i32} , %arg13: i32 {tt.divisibility = 16 : i32} , %arg14: i32 {tt.divisibility = 16 : i32} , %arg15: i32 {tt.divisibility = 16 : i32} , %arg16: i32 {tt.divisibility = 16 : i32} , %arg17: i32 {tt.divisibility = 16 : i32} , %arg18: i32 , %arg19: i32 {tt.divisibility = 16 : i32} , %arg20: i32 {tt.divisibility = 16 : i32} ) attributes {noinline = false} {
    ...
    %3 = tt.splat %2 : i64 -> tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #blocked2}>> 
    %4 = tt.splat %2 : i64 -> tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
    %5 = tt.get_program_id y : i32 
    %6 = arith.muli %5, %arg7 : i32 
    %7 = tt.addptr %arg0, %6 : !tt.ptr<f16>, i32 
    %8 = tt.splat %7 : !tt.ptr<f16> -> tensor<256x128x!tt.ptr<f16>, #blocked2> 
    %9 = arith.extsi %arg8 : i32 to i64 
    %10 = tt.splat %9 : i64 -> tensor<256x1xi64, #blocked2> 
    %11 = tt.addptr %arg1, %6 : !tt.ptr<f16>, i32 
    %12 = arith.extsi %arg11 : i32 to i64 
    %13 = tt.addptr %arg2, %6 : !tt.ptr<f16>, i32 
    %14 = arith.extsi %arg14 : i32 to i64 
    %15 = arith.mulf %arg3, %cst : f32 
    %16 = tt.make_range {end = 256 : i32, start = 0 : i32} : tensor<256xi32, #triton_gpu.slice<{dim = 1, parent = #blocked2}>> 
    %17 = tt.make_range {end = 256 : i32, start = 0 : i32} : tensor<256xi32, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
    %18 = arith.extsi %16 : tensor<256xi32, #triton_gpu.slice<{dim = 1, parent = #blocked2}>> to tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #blocked2}>> 
    %19 = arith.extsi %17 : tensor<256xi32, #triton_gpu.slice<{dim = 1, parent = #mma}>> to tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
    %20 = arith.addi %3, %18 : tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #blocked2}>> 
    %21 = arith.addi %4, %19 : tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
    %22 = tt.expand_dims %20 {axis = 1 : i32} : tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #blocked2}>> -> tensor<256x1xi64, #blocked2> 
    %23 = tt.expand_dims %21 {axis = 1 : i32} : tensor<256xi64, #triton_gpu.slice<{dim = 1, parent = #mma}>> -> tensor<256x1xi64, #mma> 
    %24 = arith.muli %22, %10 : tensor<256x1xi64, #blocked2> 
    %25 = tt.broadcast %24 : tensor<256x1xi64, #blocked2> -> tensor<256x128xi64, #blocked2> 
    ...
    %28 = arith.extsi %26 : tensor<128xi32, #triton_gpu.slice<{dim = 0, parent = #blocked2}>> to tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #blocked2}>> 
    %29 = arith.extsi %27 : tensor<128xi32, #triton_gpu.slice<{dim = 0, parent = #mma}>> to tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #mma}>> 
    %30 = tt.expand_dims %28 {axis = 0 : i32} : tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #blocked2}>> -> tensor<1x128xi64, #blocked2> 
    %31 = tt.expand_dims %29 {axis = 0 : i32} : tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #mma}>> -> tensor<1x128xi64, #mma> 
    %32 = tt.broadcast %30 : tensor<1x128xi64, #blocked2> -> tensor<256x128xi64, #blocked2> 
    %33 = tt.broadcast %31 : tensor<1x128xi64, #mma> -> tensor<256x128xi64, #mma> 
    %34 = arith.addi %25, %32 : tensor<256x128xi64, #blocked2> 
    %35 = tt.addptr %8, %34 : tensor<256x128x!tt.ptr<f16>, #blocked2>, tensor<256x128xi64, #blocked2> 
    %36 = amdgpu.extract_slice %35 [0, 0] : tensor<256x128x!tt.ptr<f16>, #blocked2> to tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %37 = amdgpu.extract_slice %35 [0, 32] : tensor<256x128x!tt.ptr<f16>, #blocked2> to tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %38 = amdgpu.extract_slice %35 [0, 64] : tensor<256x128x!tt.ptr<f16>, #blocked2> to tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %39 = amdgpu.extract_slice %35 [0, 96] : tensor<256x128x!tt.ptr<f16>, #blocked2> to tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %40 = tt.load %36 : tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %41 = tt.load %37 : tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %42 = tt.load %38 : tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %43 = tt.load %39 : tensor<256x32x!tt.ptr<f16>, #blocked2> 
    %44 = triton_gpu.local_alloc %40 : (tensor<256x32xf16, #blocked2>) -> !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> 
    %45 = triton_gpu.local_load %44 : !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
    %46 = triton_gpu.local_alloc %41 : (tensor<256x32xf16, #blocked2>) -> !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> 
    %47 = triton_gpu.local_load %46 : !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
    %48 = triton_gpu.local_alloc %42 : (tensor<256x32xf16, #blocked2>) -> !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> 
    %49 = triton_gpu.local_load %48 : !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
    %50 = triton_gpu.local_alloc %43 : (tensor<256x32xf16, #blocked2>) -> !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> 
    %51 = triton_gpu.local_load %50 : !triton_gpu.memdesc<256x32xf16, #shared3, #triton_gpu.shared_memory> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
    %52 = tt.make_range {end = 128 : i32, start = 0 : i32} : tensor<128xi32, #triton_gpu.slice<{dim = 0, parent = #blocked3}>> 
    %53 = tt.make_range {end = 128 : i32, start = 0 : i32} : tensor<128xi32, #triton_gpu.slice<{dim = 1, parent = #blocked3}>> 
    %54 = arith.extsi %52 : tensor<128xi32, #triton_gpu.slice<{dim = 0, parent = #blocked3}>> to tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #blocked3}>> 
    %55 = arith.extsi %53 : tensor<128xi32, #triton_gpu.slice<{dim = 1, parent = #blocked3}>> to tensor<128xi64, #triton_gpu.slice<{dim = 1, parent = #blocked3}>> 
    %56 = tt.expand_dims %54 {axis = 0 : i32} : tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #blocked3}>> -> tensor<1x128xi64, #blocked3> 
    %57 = tt.splat %11 : !tt.ptr<f16> -> tensor<128x128x!tt.ptr<f16>, #blocked3> 
    %58 = tt.expand_dims %55 {axis = 1 : i32} : tensor<128xi64, #triton_gpu.slice<{dim = 1, parent = #blocked3}>> -> tensor<128x1xi64, #blocked3> 
    %59 = tt.broadcast %58 : tensor<128x1xi64, #blocked3> -> tensor<128x128xi64, #blocked3> 
    %60 = tt.splat %12 : i64 -> tensor<1x128xi64, #blocked3> 
    %61 = tt.splat %15 : f32 -> tensor<256x128xf32, #mma> 
    %62 = tt.splat %13 : !tt.ptr<f16> -> tensor<128x128x!tt.ptr<f16>, #blocked3> 
    %63 = tt.splat %14 : i64 -> tensor<1x128xi64, #blocked3> 
    %64 = arith.muli %56, %63 : tensor<1x128xi64, #blocked3> 
    %65 = tt.broadcast %64 : tensor<1x128xi64, #blocked3> -> tensor<128x128xi64, #blocked3> 
    %66:5 = scf.for %arg21 = %c0_i32 to %arg20 step %c128_i32 iter_args(%arg22 = %cst_2, %arg23 = %cst_0, %arg24 = %cst_1, %arg25 = %c0_i64, %arg26 = %c0_i64) -> (tensor<256x128xf32, #mma>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, i64, i64)  : i32 {
      %79 = tt.splat %arg26 : i64 -> tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #blocked3}>> 
      %80 = arith.addi %79, %54 : tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #blocked3}>> 
      %81 = tt.expand_dims %80 {axis = 0 : i32} : tensor<128xi64, #triton_gpu.slice<{dim = 0, parent = #blocked3}>> -> tensor<1x128xi64, #blocked3> 
      %82 = arith.muli %81, %60 : tensor<1x128xi64, #blocked3> 
      %83 = tt.broadcast %82 : tensor<1x128xi64, #blocked3> -> tensor<128x128xi64, #blocked3> 
      %84 = arith.addi %59, %83 : tensor<128x128xi64, #blocked3> 
      %85 = tt.addptr %57, %84 : tensor<128x128x!tt.ptr<f16>, #blocked3>, tensor<128x128xi64, #blocked3> 
      %86 = amdgpu.extract_slice %85 [0, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %87 = amdgpu.extract_slice %85 [32, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %88 = amdgpu.extract_slice %85 [64, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %89 = amdgpu.extract_slice %85 [96, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %90 = tt.load %86 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %91 = tt.load %87 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %92 = tt.load %88 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %93 = tt.load %89 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %94 = triton_gpu.local_alloc %90 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %95 = triton_gpu.local_load %94 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %96 = triton_gpu.local_alloc %91 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %97 = triton_gpu.local_load %96 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %102 = tt.dot %45, %95, %cst_2 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %98 = triton_gpu.local_alloc %92 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %99 = triton_gpu.local_load %98 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %100 = triton_gpu.local_alloc %93 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %101 = triton_gpu.local_load %100 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %103 = tt.dot %47, %97, %102 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %104 = tt.dot %49, %99, %103 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %105 = tt.dot %51, %101, %104 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %106 = arith.mulf %105, %61 : tensor<256x128xf32, #mma> 
      ...
      %108 = arith.maxnumf %arg24, %107 : tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
      %109 = tt.expand_dims %108 {axis = 1 : i32} : tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> -> tensor<256x1xf32, #mma> 
      %110 = tt.broadcast %109 : tensor<256x1xf32, #mma> -> tensor<256x128xf32, #mma> 
      %111 = arith.subf %106, %110 : tensor<256x128xf32, #mma> 
      %112 = math.exp2 %111 : tensor<256x128xf32, #mma> 
      %113 = arith.subf %arg24, %108 : tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
      %114 = math.exp2 %113 : tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
      %115 = tt.expand_dims %114 {axis = 1 : i32} : tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> -> tensor<256x1xf32, #mma> 
      %116 = tt.broadcast %115 : tensor<256x1xf32, #mma> -> tensor<256x128xf32, #mma> 
      %117 = arith.mulf %arg22, %116 : tensor<256x128xf32, #mma> 
      %118 = tt.splat %arg25 : i64 -> tensor<128xi64, #triton_gpu.slice<{dim = 1, parent = #blocked3}>> 
      %119 = arith.addi %118, %55 : tensor<128xi64, #triton_gpu.slice<{dim = 1, parent = #blocked3}>> 
      %120 = tt.expand_dims %119 {axis = 1 : i32} : tensor<128xi64, #triton_gpu.slice<{dim = 1, parent = #blocked3}>> -> tensor<128x1xi64, #blocked3> 
      %121 = tt.broadcast %120 : tensor<128x1xi64, #blocked3> -> tensor<128x128xi64, #blocked3> 
      %122 = arith.addi %121, %65 : tensor<128x128xi64, #blocked3> 
      %123 = tt.addptr %62, %122 : tensor<128x128x!tt.ptr<f16>, #blocked3>, tensor<128x128xi64, #blocked3> 
      %124 = arith.truncf %112 : tensor<256x128xf32, #mma> to tensor<256x128xf16, #mma> 
      %125 = amdgpu.extract_slice %124 [0, 0] : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
      %126 = amdgpu.extract_slice %124 [0, 32] : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
      %127 = amdgpu.extract_slice %124 [0, 64] : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
      %128 = amdgpu.extract_slice %124 [0, 96] : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
      %129 = triton_gpu.convert_layout %125 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
      %130 = triton_gpu.convert_layout %126 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
      %131 = triton_gpu.convert_layout %127 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
      %132 = triton_gpu.convert_layout %128 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
      %133 = amdgpu.extract_slice %123 [0, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %134 = amdgpu.extract_slice %123 [32, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %135 = amdgpu.extract_slice %123 [64, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %136 = amdgpu.extract_slice %123 [96, 0] : tensor<128x128x!tt.ptr<f16>, #blocked3> to tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %137 = tt.load %133 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %138 = tt.load %134 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %139 = tt.load %135 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %140 = tt.load %136 : tensor<32x128x!tt.ptr<f16>, #blocked3> 
      %141 = triton_gpu.local_alloc %137 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %142 = triton_gpu.local_load %141 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %143 = triton_gpu.local_alloc %138 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %144 = triton_gpu.local_load %143 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %145 = triton_gpu.local_alloc %139 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %146 = triton_gpu.local_load %145 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %147 = triton_gpu.local_alloc %140 : (tensor<32x128xf16, #blocked3>) -> !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> 
      %148 = triton_gpu.local_load %147 : !triton_gpu.memdesc<32x128xf16, #shared4, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %149 = tt.dot %129, %142, %117 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %150 = tt.dot %130, %144, %149 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %151 = tt.dot %131, %146, %150 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %152 = tt.dot %132, %148, %151 : tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<256x128xf32, #mma> 
      %153 = "tt.reduce"(%112) <{axis = 1 : i32}> ({
      ^bb0(%arg27: f32 , %arg28: f32 ):
        %158 = arith.addf %arg27, %arg28 : f32 
        tt.reduce.return %158 : f32 
      }) : (tensor<256x128xf32, #mma>) -> tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
      %154 = arith.mulf %arg23, %114 : tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> 
      ...
      scf.yield %152, %155, %108, %156, %157 : tensor<256x128xf32, #mma>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, i64, i64 
    } {tt.divisibility_arg1 = dense<128> : tensor<1xi32>} 
    %67 = tt.expand_dims %66#1 {axis = 1 : i32} : tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>> -> tensor<256x1xf32, #mma> 
    %68 = tt.broadcast %67 : tensor<256x1xf32, #mma> -> tensor<256x128xf32, #mma> 
    %69 = arith.divf %66#0, %68 : tensor<256x128xf32, #mma> 
    %70 = tt.addptr %arg5, %6 : !tt.ptr<f16>, i32 
    %71 = arith.extsi %arg17 : i32 to i64 
    %72 = arith.truncf %69 : tensor<256x128xf32, #mma> to tensor<256x128xf16, #mma> 
    %73 = tt.splat %70 : !tt.ptr<f16> -> tensor<256x128x!tt.ptr<f16>, #mma> 
    %74 = tt.splat %71 : i64 -> tensor<256x1xi64, #mma> 
    %75 = arith.muli %23, %74 : tensor<256x1xi64, #mma> 
    %76 = tt.broadcast %75 : tensor<256x1xi64, #mma> -> tensor<256x128xi64, #mma> 
    %77 = arith.addi %76, %33 : tensor<256x128xi64, #mma> 
    %78 = tt.addptr %73, %77 : tensor<256x128x!tt.ptr<f16>, #mma>, tensor<256x128xi64, #mma> 
    tt.store %78, %72 : tensor<256x128x!tt.ptr<f16>, #mma> 
    tt.return 
  } 
} """
...
tt.func public @_attn_fwd(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg1: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg2: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg3: f32 , %arg4: !tt.ptr<f32> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg5: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg6: i32 {tt.divisibility = 16 : i32} , %arg7: i32 {tt.divisibility = 16 : i32} , %arg8: i32 {tt.divisibility = 16 : i32} , %arg9: i32 {tt.divisibility = 16 : i32} , %arg10: i32 {tt.divisibility = 16 : i32} , %arg11: i32 {tt.divisibility = 16 : i32} , %arg12: i32 {tt.divisibility = 16 : i32} , %arg13: i32 {tt.divisibility = 16 : i32} , %arg14: i32 {tt.divisibility = 16 : i32} , %arg15: i32 {tt.divisibility = 16 : i32} , %arg16: i32 {tt.divisibility = 16 : i32} , %arg17: i32 {tt.divisibility = 16 : i32} , %arg18: i32 {tt.divisibility = 16 : i32} , %arg19: i32 {tt.divisibility = 16 : i32} , %arg20: i32 {tt.divisibility = 16 : i32} ) attributes {noinline = false} {
    ...
    %55:5 = scf.for %arg21 = %c0_i32 to %arg20 step %c128_i32 iter_args(%arg22 = %cst, %arg23 = %cst_1, %arg24 = %cst_0, %arg25 = %c0_i64, %arg26 = %c0_i64) -> (tensor<256x128xf32, #mma>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, i64, i64)  : i32 {
        ...
        %84 = amdgpu.extract_slice %46[0, 0]  : tensor<256x128xf16, #blocked2> to tensor<256x32xf16, #blocked2> 
        ...
        %87 = amdgpu.extract_slice %83[0, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
        ...
        %91 = amdgpu.extract_slice %46[0, 32]  : tensor<256x128xf16, #blocked2> to tensor<256x32xf16, #blocked2> 
        ...
        %94 = amdgpu.extract_slice %83[32, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
        ...
        %98 = amdgpu.extract_slice %46[0, 64]  : tensor<256x128xf16, #blocked2> to tensor<256x32xf16, #blocked2> 
        ...
        %101 = amdgpu.extract_slice %83[64, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
        ...
        %105 = amdgpu.extract_slice %46[0, 96]  : tensor<256x128xf16, #blocked2> to tensor<256x32xf16, #blocked2> 
        ...
        %108 = amdgpu.extract_slice %83[96, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
        ...
        %125 = amdgpu.extract_slice %123[0, 0]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
        %126 = triton_gpu.convert_layout %125 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
        %127 = amdgpu.extract_slice %124[0, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
        ...
        %129 = triton_gpu.local_load %128 : !tt.memdesc<32x128xf16, #shared1, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
         %131 = amdgpu.extract_slice %123[0, 32]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
        %132 = triton_gpu.convert_layout %131 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
        %133 = amdgpu.extract_slice %124[32, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
        ...
        %137 = amdgpu.extract_slice %123[0, 64]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
        %138 = triton_gpu.convert_layout %137 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
        %139 = amdgpu.extract_slice %124[64, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
        ...
        %143 = amdgpu.extract_slice %123[0, 96]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
        %144 = triton_gpu.convert_layout %143 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
        %145 = amdgpu.extract_slice %124[96, 0] : tensor<128x128xf16, #blocked3> to tensor<32x128xf16, #blocked3> 
...
#blocked1 = #triton_gpu.blocked<{sizePerThread = [8, 4], threadsPerWarp = [2, 32], warpsPerCTA = [1, 8], order = [1, 0]}>
#mma = #triton_gpu.amd_mfma<{versionMajor = 3, versionMinor = 0, warpsPerCTA = [8, 1], instrShape = [32, 32], isTransposed = true}>
#shared = #triton_gpu.shared<{vec = 1, perPhase = 1, maxPhase = 1, order = [0, 1], hasLeadingOffset = false}>
#shared1 = #triton_gpu.shared<{vec = 1, perPhase = 1, maxPhase = 1, order = [1, 0], hasLeadingOffset = false}>
module attributes {"triton_gpu.num-ctas" = 1 : i32, "triton_gpu.num-warps" = 8 : i32, triton_gpu.target = "hip:gfx942", "triton_gpu.threads-per-warp" = 64 : i32} {
  tt.func public @_attn_fwd(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg1: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg2: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg3: f32 , %arg4: !tt.ptr<f32> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg5: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} , %arg6: i32 {tt.divisibility = 16 : i32} , %arg7: i32 {tt.divisibility = 16 : i32} , %arg8: i32 {tt.divisibility = 16 : i32} , %arg9: i32 {tt.divisibility = 16 : i32} , %arg10: i32 {tt.divisibility = 16 : i32} , %arg11: i32 {tt.divisibility = 16 : i32} , %arg12: i32 {tt.divisibility = 16 : i32} , %arg13: i32 {tt.divisibility = 16 : i32} , %arg14: i32 {tt.divisibility = 16 : i32} , %arg15: i32 {tt.divisibility = 16 : i32} , %arg16: i32 {tt.divisibility = 16 : i32} , %arg17: i32 {tt.divisibility = 16 : i32} , %arg18: i32 , %arg19: i32 {tt.divisibility = 16 : i32} , %arg20: i32 {tt.divisibility = 16 : i32} ) attributes {noinline = false} {
    ...
    %74 = amdgpu.extract_slice %40[0, 32]  : tensor<256x128x!tt.ptr<f16>, #blocked> to tensor<256x32x!tt.ptr<f16>, #blocked> 
    ...
    %63 = amdgpu.extract_slice %40[0, 0]  : tensor<256x128x!tt.ptr<f16>, #blocked> to tensor<256x32x!tt.ptr<f16>, #blocked> 
    ...
    %78 = amdgpu.extract_slice %40[0, 64]  : tensor<256x128x!tt.ptr<f16>, #blocked> to tensor<256x32x!tt.ptr<f16>, #blocked> 
    ...
    %82 = amdgpu.extract_slice %40[0, 96]  : tensor<256x128x!tt.ptr<f16>, #blocked> to tensor<256x32x!tt.ptr<f16>, #blocked> 
    ...
    %50:5 = scf.for %arg21 = %c0_i32 to %arg20 step %c128_i32 iter_args(%arg22 = %cst_2, %arg23 = %cst_0, %arg24 = %cst_1, %arg25 = %c0_i64, %arg26 = %c0_i64) -> (tensor<256x128xf32, #mma>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, tensor<256xf32, #triton_gpu.slice<{dim = 1, parent = #mma}>>, i64, i64)  : i32 {
      ...
      %72 = amdgpu.extract_slice %71[0, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      ...
      %103 = triton_gpu.local_load %102 : !tt.memdesc<32x128xf16, #shared1, #triton_gpu.shared_memory> -> tensor<32x128xf16, #triton_gpu.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> 
      %76 = amdgpu.extract_slice %71[32, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      ...
      %80 = amdgpu.extract_slice %71[64, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      ...
      amdgpu.instruction_sched_hint 
      %84 = amdgpu.extract_slice %71[96, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      ...
      %92 = amdgpu.extract_slice %91[0, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      ...
      amdgpu.instruction_sched_hint 
      %94 = amdgpu.extract_slice %91[32, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      %95 = tt.load %94 : tensor<32x128x!tt.ptr<f16>, #blocked1> 
      %96 = amdgpu.extract_slice %91[64, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      ...
      %133 = amdgpu.extract_slice %132[0, 0]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
      ...
      amdgpu.instruction_sched_hint 
      %98 = amdgpu.extract_slice %91[96, 0] : tensor<128x128x!tt.ptr<f16>, #blocked1> to tensor<32x128x!tt.ptr<f16>, #blocked1> 
      %99 = tt.load %98 : tensor<32x128x!tt.ptr<f16>, #blocked1>
      %138 = amdgpu.extract_slice %132[0, 32]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
      ...
      amdgpu.instruction_sched_hint 
      %143 = amdgpu.extract_slice %132[0, 64]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
      %144 = triton_gpu.convert_layout %143 : tensor<256x32xf16, #mma> -> tensor<256x32xf16, #triton_gpu.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> 
      ...
      amdgpu.instruction_sched_hint 
      %148 = amdgpu.extract_slice %132[0, 96]  : tensor<256x128xf16, #mma> to tensor<256x32xf16, #mma> 
